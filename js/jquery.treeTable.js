    ...
    $.fn.collapse = function () {
        return this.each(function () {
            ...
            childrenOf($(this)).each(function () {
                ...
                $(this).addClass('ui-helper-hidden');
                i--;
                if ($.isFunction(options.onNodeHide) && i==0) {
    ...
    $.fn.expand = function () {
        return this.each(function () {
            ...
            childrenOf($(this)).each(function () {
                ...
                i--;
                if ($.isFunction(options.onNodeShow) && i == 0) {
        ...
        if (!node.hasClass("initialized")) {
            ...
            if (node.hasClass("parent")) {
                ...
                if (options.expandable) {
                    var newLink = '<a href="#" title="' + options.stringExpand + '" style="margin-left: -' + (options.indent3 || options.indent) + 'px; padding-left: ' + (options.indent2 || options.indent) + 'px" class="expander"></a>';
