...
!function ($) {
    ...
    Datepicker.prototype = {
        ...
        show: function (e) {
            ...
            this.picker.show().css('z-index', 1100);
        ...
        update: function () {
            var date = this.element.val() || this.element.text();
    ...
    var DPGlobal = {
        ...
        dates: {
            days: ["星期天", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
